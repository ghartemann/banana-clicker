...
if (localStorage.getItem("clicksPerClick") === null) {
  ...
  document.getElementById("cpcDisplay").innerHTML =
    "You are getting: " + perclick + " per click";
}
if (localStorage.getItem("clicksPerSecond") === null) {
  ...
  document.getElementById("cpsDisplay").innerHTML =
    "You are getting: " + persecond + " per second";
}
if (localStorage.getItem("clickerPrice") === null) {
  ...
  document.getElementById("ClickerBuy").innerHTML =
    "1+ Cookies per second! " + clickerPrice + " cookies.";
}
if (localStorage.getItem("bigCPCprice") === null) {
  ...
  document.getElementById("bigcpcBuy").innerHTML =
    "+6 cookies per click! " + bigcpcUpPrice + " cookies.";
}
if (localStorage.getItem("priceOfClicker") === null) {
  ...
  document.getElementById("smallcpcBuy").innerHTML =
    "+1 cookie per click! " + cpcPrice + " cookies.";
}
if (localStorage.getItem("BigclickerPrice") === null) {
  ...
  document.getElementById("BigClickerBuy").innerHTML =
    "5+ Cookies Per Second! " + BigclickerPrice + " cookies!";
}
...
function cpcUp() {
  if (clicks >= cpcPrice) {
    ...
    document.getElementById("cookies").innerHTML = clicks;
    document.getElementById("smallcpcBuy").innerHTML =
      "+1 Cookies Per Click! " + cpcPrice + " cookies.";
    document.getElementById("cpcDisplay").innerHTML =
      "You are getting: " + perclick + " per click";
