...
values  (1, 'tierClicker', 'un', 'autoclicker', 'hand.png', 40, 1, 1.15, 'Un curseur qui clique tout seul. En plus on le voit faire. C''est pas formidable, ça ?'),
        ...
        (8, 'tierPlantation', 'une', 'bananeraie', 'plantation.png', 600000, 1000, 1.16, 'Une bananeraie composée d''un certain nombre de bananiers. Et qui donc, de façon assez logique, produit beaucoup plus de bananes. Pourquoi en acheter un quand on peut en acheter toute une collection ? Vous faites bien ce que vous voulez, mais c''est clairement plus avantageux.'),
        (9, 'tierRifle', 'un', 'fusil', 'rifle.png', 1000000, 1776, 1.17, 'Un fusil. Pour chasser les bananes sauvages. Ça paraît assez évident.'),
        (10, 'tierBoat', 'un', 'gros bateau', 'boat.png', 2000000, 2500, 1.19, 'Un bateau qui transporte des bananes, pourquoi pas. Mais si on suit le fil rouge de nos précédents achats, est-ce que ce bateau ne devrait pas lui-même produire des bananes ? On a pas la réponse. Ce jeu commence à prendre de grosses libertés vis-à-vis du lore, c''est assez irritant.'),
        (11, 'tierPlane', 'un', 'avion cargo', 'airplane.png', 3000000, 3500, 1.19, 'Un transport très rapide, très efficace et très peu éco-responsable. Mais priverait-on le monde de bananes pour de vulgaires considérations écologiques ? Allons.'),
        (12, 'tierWormhole', 'un', 'trou de ver', 'wormhole.png', 15000000000, 100000, 1.23, 'Allez chercher vos bananes dans une autre galaxie. Le risque d''un effondrement de l''espace-temps est non nul, non négligeable et non improbable, mais l''appel des bananes est plus fort que ces basses considérations.');
...
values  (1, 'buffFertilizer', 'Sac d''engrais Monsanto', 'fertilizer.png', 'BPS', 2000, 1.3, '30%', 1.15, 'Tree', 'bananier', 'Du bon engrais Monsanto chargé de pesticides pour rendre vos bananiers plus grands, plus forts, plus productifs et plus intelligents. Un outil idéal – si le risque élevé de cancer de la gorge, des intestins ou du colon vous importe peu.'),
        ...
        (4, 'buffAdblock', 'Installer BloquePub™', 'blocker.png', 'BPS', 69420, 0, '0', 1, 'Ad', 'BloquePub™', 'Oui bon effectivement, afficher des pubs chez vous n''était pas forcément une bonne idée. Installez donc ce bloqueur de publicités. Ah oui, forcément, les bénéfices rapportés par la publicité seront entièrement annulés mais on ne peut pas avoir le beurre et l''argent du beurre, hein ?'),
        (5, 'buffBulldozer', 'Déforestation massive', 'bulldozer.png', 'BPS', 850000, 1.1, '10%', 1.15, 'Plantation', 'bananeraie', 'Arracher des arbres centenaires et les remplacer par des bananiers. Sur des kilomètres carrés. Vous voulez des bananes ou sauver la planète ? Alors.'),
        (6, 'buffGag', 'Baillonner les toucans', 'gag.png', 'BPS', 1000000, 1.15, '15%', 1.16, 'Toucan', 'toucan', 'Ces toucans sont théoriquement muets mais il suffirait d''un pour risquer de syndicaliser tout ce petit monde. Avec ces baillons, on s''assure en amont que la question ne se posera jamais.'),
